...
class SlideShows_Model_SlideShow extends Com_Module_Model {
    ...
    public function getListEnable($lanId, $type) {
        $text = new Entities_SlideShow();
        return $text->getAll($text->getList()->where("SliLanId={$lanId} and SliType={$type} and SliStatus=1"));
    }
