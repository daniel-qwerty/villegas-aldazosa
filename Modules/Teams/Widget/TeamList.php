...
<div class="gdlr-core-personnel-list-column  gdlr-core-column-20 gdlr-core-item-pdlr">
    <div class="gdlr-core-personnel-list gdlr-core-outer-frame-element clearfix"
        ...
        <div
            ...
            <a
                href="<?=Com_Helper_Url::getInstance()->urlBase . '/' . $this->lan->LanCode . '/perfil/' . $item->TeamId?>"><img
                    src="<?PHP echo Com_Helper_Url::getInstance()->getUploads(); ?>/Image/<?=$item->TeamThumb?>" alt
                    width=599 height=551 title=Emma2></a>
        </div>
        <div class=gdlr-core-personnel-list-content-wrap>
            <h3 class="gdlr-core-personnel-list-title"
                style="font-size: 14px ;font-weight: 600 ;letter-spacing: 3px ;margin-bottom: 4px ;"><a
