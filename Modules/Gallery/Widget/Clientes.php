...
class Gallery_Widget_Clientes extends Com_Object
{
    ...
    public function render()
    {
        ...
        foreach ($list as $new) {
            ?>
<div class="brand-box">
    <a target="_blank" href="<?PHP echo $new->GalName; ?>"><img class="img-responsive"
            src="<?=Com_Helper_Url::getInstance()->getUploads();?>/Image/<?PHP echo $new->GalFile; ?>"
            alt="<?PHP echo $new->GalName; ?>"></a>
</div>
...
<div class="gdlr-core-item-list gdlr-core-gallery-column  gdlr-core-column-12  gdlr-core-item-pdlr gdlr-core-item-mgb">
    <div class="gdlr-core-gallery-list gdlr-core-media-image"><img
            src="<?=Com_Helper_Url::getInstance()->getUploads();?>/Image/<?PHP echo $new->GalFile; ?>"
            alt="<?PHP echo $new->GalName; ?>" width=220 height=120 title="<?PHP echo $new->GalName; ?>"></div>
</div>
...
<img src="<?=Com_Helper_Url::getInstance()->getUploads();?>/Image/<?PHP echo $new->GalFile; ?>" alt width=400 height=71
    title=logo>
...
<img class="alignnone size-full wp-image-6129"
    src="<?=Com_Helper_Url::getInstance()->getUploads();?>/Image/<?PHP echo $new->GalFile; ?>" alt width=450>
    ...
    <div class=gdlr-core-portfolio-modern-desc>
        <div class="gdlr-core-portfolio-thumbnail gdlr-core-media-image ">
            <div class="gdlr-core-portfolio-thumbnail-image-wrap  gdlr-core-zoom-on-hover"><img
                    src=<?=Com_Helper_Url::getInstance()->getUploads();?>/Image/<?PHP echo $new->GalFile; ?> alt
                width=600 height=600 title=Family1><span
                    ...
                    style="background: rgba(14, 60, 91, 0.8) ;"><span class=gdlr-core-image-overlay-content><span
                            class=gdlr-core-portfolio-icon-wrap><a class="gdlr-core-lightgallery gdlr-core-js "
                                href=<?=Com_Helper_Url::getInstance()->getUploads();?>/Image/<?PHP echo $new->GalFile;
                            ...
                            style="font-size: 18px ;font-weight: 700 ;letter-spacing: 0px ;text-transform: none ;"><a
                                href=#>
                                <?PHP echo $new->GalName; ?></a></span><span
